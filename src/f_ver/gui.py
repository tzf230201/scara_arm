...
selected_csv_path = tk.StringVar(value="")  # <== menyimpan path CSV yang dipilih
...
def send_dancing():
    ...
    send("dancing", motor=current_motor(), csv_path=csv_path)
...
# ==== NEW BUTTONS ====
tk.Button(root, text="Choose CSV", bg="lightblue",
          command=choose_csv).grid(row=17, column=0, sticky="ew")
