...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "zlis42_sender");
    ros::NodeHandle nh;

    // Create a subscriber for the "zlac706_sender/chatter" topic
    ros::Subscriber chatter_sub = nh.subscribe("zlis42_receiver/chatter", 1000, chatterCallback);

    // Create a publisher for the "zlac706_receiver/chatter" topic
    pub = nh.advertise<std_msgs::String>("zlis42_sender/chatter", 1000);
