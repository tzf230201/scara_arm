...
class JointStateSorter:
    ...
    def execution_end_callback(self, msg):
        ...
        i=1
        degrees11= targets[0]['position'][0]
        degrees21= targets[0]['position'][1]
        degrees31= targets[0]['position'][2]
        dt= 1
        for target in targets:
            ...
            print(len(targets))
            current_d = target
            degrees12 = (target[1] / 3.14 * 180) * 5
            degrees22 = (target[2] / 3.14 * 180) * 5 + d1 * degrees12
            degrees32 = (target[3] / 3.14 * 180) * 5 + d2 * degrees22
