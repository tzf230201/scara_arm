...
# NOTE: Do not read files or talk to hardware at import time.
# These are initialized lazily when the relevant command is executed.
robot_tar_coor = []
servo_tar_coor = []
motion_enable = True
motion_cnt = 0
