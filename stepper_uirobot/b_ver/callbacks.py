...
def pp_joint(msg, state):
    ...
    # hitung v_max dan acc triangle
    v_max = max(2 * d / t for d in delta)   # pulses/sec (ambil max dari semua joint)
...
def read_position(msg, state):
    ...
    print(f"[cb] Read Position: pa2={pa2_deg:<2}, pa3={pa3_deg:<2}, pa4={pa4_deg:<2} degree")
