...
def dancing(msg, state):
    """
    Callback untuk command 'dancing'
    Sekarang mendukung pengiriman path CSV dari GUI.
    Jika path CSV dikirim dari GUI, maka disimpan di state dan dijalankan.
    Jika tidak ada CSV dikirim, akan gunakan CSV terakhir (jika ada di state).
    """
